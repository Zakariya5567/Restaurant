    ...
    return   GetBuilder(
                      ...
                      builder: (controller) {
                        return orderController.isLoading == true
                            ...
                            :orderController.companyOrdersModel.isBlank||
                             orderController.companyOrdersModel.todaysOrders.isBlank ||
                                    orderController.companyOrdersModel.todaysOrders.isEmpty
                            ...
                            //         orderController.orderListModel.data.isEmpty
                                ...
                                : ListView.builder(
                                    itemCount: orderController.companyOrdersModel.todaysOrders.length,
                                    //  orderController
                                    ...
                                    itemBuilder: ((context, index) {
                                      ...
                                      final order = orderController
                                          .companyOrdersModel.todaysOrders[index];
                                      // final order = orderController
