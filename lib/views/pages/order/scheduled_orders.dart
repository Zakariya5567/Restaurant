...
class ScheduledOrders extends StatelessWidget {
  ScheduledOrders({Key key}) : super(key: key);
    ...
    return   GetBuilder(
                      ...
                      builder: (controller) {
                        return orderController.isLoading == true
                            ...
                            :
                             orderController.companyOrdersModel.upcomingOrders.isBlank ||
                                    orderController.companyOrdersModel.upcomingOrders.isEmpty
                            ...
                            //         orderController.orderListModel.data.isEmpty
                                ...
                                : ListView.builder(
                                    itemCount: orderController.companyOrdersModel.upcomingOrders.length,
                                    //  orderController
                                    ...
                                    itemBuilder: ((context, index) {
                                      ...
                                      final order = orderController
                                          .companyOrdersModel.upcomingOrders[index];
                                      // final order = orderController
